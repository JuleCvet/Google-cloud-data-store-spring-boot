...
public class Assignment {
	...
	public Assignment(String assignmentId, String customer, String partner, String role, String extend,
	...
	public String toString() {
		return "Assignment [AssignmentId=" + AssignmentId + ", customer=" + customer + ", partner=" + partner + ", role="
				+ role + ", extend=" + extend + ", startDate=" + startDate + ", endDate=" + endDate + ", comment="
				+ comment + "]";
	}   
}
