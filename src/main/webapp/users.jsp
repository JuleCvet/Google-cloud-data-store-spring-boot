		...
		<table class="table table-striped table-bordered">
		 ...
		 <c:forEach var="user" items="${list}">
			<tr>
				<td>${user.email}</td>
				<td>${user.fullName}</td>
				<td><a href="${pageContext.request.contextPath}/registration" style="color:#004085;"><b>View status</b></a></td>
				<td><a href="${pageContext.request.contextPath}/registration" style="color:#004085;"><b>View assignment</b></a></td>
			</tr>
			</c:forEach>
		</table>
		<br/>
